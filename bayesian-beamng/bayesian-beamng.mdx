...
$$ 
k(x_i, x_j) = \sigma^2 \cdot \exp\left(- \frac{\Vert x_i - x_j \Vert^2}{2 l^2}\right)
$$

If you'd like to learn exactly how this kernel defines the shape of the GP, I encourage you to visit the paper
